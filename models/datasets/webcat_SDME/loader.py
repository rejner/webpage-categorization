...
class WebCatSDMELoader(DatasetLoaderInterface):
    def __init__(self, train_path=['train.json'], test_path=['test.json'],
                       val_path=['dev.json'], dataset_name='WebCatSDME', labels_path='label.json', dataset_dir=os.path.dirname(os.path.abspath(__file__))):
            ...
            dataset = [
                {
                    ...
                    "ner": tf.convert_to_tensor(obj['tags'], dtype=tf.int64),
