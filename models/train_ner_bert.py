...
from architectures.my_ner_model import MyNERModel, MyNERModel_BERT_LSTM, MyNERModel_BERT_Last_Four_LSTM
...
if __name__ == "__main__":
    ...
    # model = MyNERModel_BERT_LSTM(num_classes=9+1)
    model = MyNERModel_BERT_Last_Four_LSTM(num_classes=12+1)
